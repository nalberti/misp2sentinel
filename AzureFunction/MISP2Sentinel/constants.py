...
EXISTING_INDICATORS_HASH_FILE_NAME = '/tmp/existing_indicators_hash.json'
EXPIRATION_DATE_TIME = 'expirationDateTime'
EXPIRATION_DATE_FILE_NAME = '/tmp/expiration_date.txt'
PARSED_INDICATORS_FILE_NAME = '/tmp/parsed_indicators.txt'
